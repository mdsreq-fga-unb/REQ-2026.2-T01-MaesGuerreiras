...
| Planejamento da Release | Análise e Consenso | Priorização de Requisitos | Priorização MoSCoW, Análise de Custo/Benefício | Escopo do MVP (CP1, CP2, autenticação mínima e consulta ou exportação simples das doações) priorizado e acordado com a coordenação. |
